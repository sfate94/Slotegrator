...
var getCompareSnapshotsPlugin = function getCompareSnapshotsPlugin(on) {
  ...
  on('before:browser:launch', function (browser, launchOptions) {
    var height = process.env.HEIGHT || '1280';
    var width = process.env.WIDTH || '720';

    if (browser.name === 'chrome') {
      launchOptions.args.push("--window-size=".concat(height, ",").concat(width));
